"""
Django settings for helloworld_gui_38620 project.
...
ROOT_URLCONF = 'helloworld_gui_38620.urls'
...
WSGI_APPLICATION = 'helloworld_gui_38620.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "helloworld_gui_38620 API",
    "DESCRIPTION": "API documentation for helloworld_gui_38620 App",
    "VERSION": "v1",
}
